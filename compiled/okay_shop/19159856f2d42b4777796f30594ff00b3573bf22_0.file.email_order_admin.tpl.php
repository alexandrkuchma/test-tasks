<?php
/* Smarty version 3.1.36, created on 2020-06-20 17:46:10
  from 'C:\OSPanel\domains\test-tasks\backend\design\html\email\email_order_admin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5eee2132a26807_37173182',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '19159856f2d42b4777796f30594ff00b3573bf22' => 
    array (
      0 => 'C:\\OSPanel\\domains\\test-tasks\\backend\\design\\html\\email\\email_order_admin.tpl',
      1 => 1591208404,
      2 => 'file',
    ),
  ),
...
function content_5eee2132a26807_37173182 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['order']->value->paid) {?>
    <?php $_smarty_tpl->_assignInScope('subject', ((string)$_smarty_tpl->tpl_vars['btr']->value->email_order)." ".((string)$_smarty_tpl->tpl_vars['order']->value->id)." ".((string)$_smarty_tpl->tpl_vars['btr']->value->email_paid) ,false ,32);
} else { ?>
    <?php $_smarty_tpl->_assignInScope('subject', ((string)$_smarty_tpl->tpl_vars['btr']->value->email_new_order)." ".((string)$_smarty_tpl->tpl_vars['order']->value->id) ,false ,32);
}?>
...
:</span></td>
                                                            ...
                                                            <?php }?>
                                                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"email_order_admin_contact_info"),$_smarty_tpl ) );?>
...
" style="font-family: 'Trebuchet MS';font-size: 16px;color: #222;text-decoration: none;line-height: normal;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['purchase']->value->product_name, ENT_QUOTES, 'UTF-8', true);?>
                                                                                                ...
                                                                                                <?php }?>
                                                                                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"email_order_admin_purchase_name",'vars'=>array('purchase'=>$_smarty_tpl->tpl_vars['purchase']->value)),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                                ...
                                                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"email_order_admin_custom_block"),$_smarty_tpl ) );?>
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <table style="width: 500px;" cellspacing="1" cellpadding="1" border="0" align="right">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="text-align: right; font-size: 18px; line-height: 150%;"><?php echo $_smarty_tpl->tpl_vars['btr']->value->email_order_discount;?>
:</td>
...
&nbsp;%</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="text-align: right; font-size: 18px; line-height: 150%;"><?php echo $_smarty_tpl->tpl_vars['btr']->value->email_order_coupon;?>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['currency']->value->sign;?>
 <?php } else {
                                                                                        ...
                                                                                        <tr class="es-p5t">
                                                                                            <td style="text-align: right; font-size: 20px; line-height: 150%;"><strong><?php echo $_smarty_tpl->tpl_vars['btr']->value->email_order_total;?>
:</strong></td>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['currency']->value->sign;?>
                                                                                        ...
                                                                                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"email_order_admin_total"),$_smarty_tpl ) );?>
