<?php
/* Smarty version 3.1.36, created on 2020-06-21 22:28:56
  from 'C:\OSPanel\domains\test-tasks\design\okay_shop\html\pagination.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5eefb4f81aef13_46773860',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bb448e51f6b5979b6274e85d79d2a9359f1b985a' => 
    array (
      0 => 'C:\\OSPanel\\domains\\test-tasks\\design\\okay_shop\\html\\pagination.tpl',
      1 => 1591208405,
      2 => 'file',
    ),
  ),
...
function content_5eefb4f81aef13_46773860 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <ul class="pagination<?php if ($_smarty_tpl->tpl_vars['ajax']->value) {?> fn_is_ajax<?php }?>">
        ...
        <?php $_smarty_tpl->_assignInScope('page_to', min($_smarty_tpl->tpl_vars['page_from']->value+$_smarty_tpl->tpl_vars['visible_pages']->value,$_smarty_tpl->tpl_vars['total_pages_num']->value-1));?>
            ...
            <li class="pagination__item">
                <a class="pagination__link" href="<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value == 2) {
...
}?>" aria-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value->pagination_prev;?>
">
        ...
        <?php } else { ?>
            <li class="pagination__item">
                <a class="pagination__link" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>null),$_smarty_tpl ) );?>
">1</a>
            </li>
        <?php }?>
...
?>
            ...
            <?php if (($_smarty_tpl->tpl_vars['p']->value == $_smarty_tpl->tpl_vars['page_from']->value+1 && $_smarty_tpl->tpl_vars['p']->value != 2) || ($_smarty_tpl->tpl_vars['p']->value == $_smarty_tpl->tpl_vars['page_to']->value && $_smarty_tpl->tpl_vars['p']->value != $_smarty_tpl->tpl_vars['total_pages_num']->value-1)) {?>
                <li class="pagination__item">
                    <a class="pagination__link" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>$_smarty_tpl->tpl_vars['p']->value),$_smarty_tpl ) );?>
">...</a>
                </li>
...
?>
        ...
        <?php } else { ?>
            <li class="pagination__item">
                <a class="pagination__link" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>$_smarty_tpl->tpl_vars['total_pages_num']->value),$_smarty_tpl ) );?>
"><?php echo $_smarty_tpl->tpl_vars['total_pages_num']->value;?>
        ...
        <?php }?>
                ...
                <li class="pagination__item">
            <a class="pagination__link" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>'all'),$_smarty_tpl ) );?>
" data-language="pagination_all"><?php echo $_smarty_tpl->tpl_vars['lang']->value->pagination_all;?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['current_page_num']->value < $_smarty_tpl->tpl_vars['total_pages_num']->value) {?>
            <li class="pagination__item">
                <a class="pagination__link" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>$_smarty_tpl->tpl_vars['current_page_num']->value+1),$_smarty_tpl ) );?>
